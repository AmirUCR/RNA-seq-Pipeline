...
# Files
edger_file = OUT_DIR / "edger_results_test.csv"
samples_file = CONFIG_DIR / "samples.tsv"
output_file = OUT_DIR / "edger_results_filtered.csv"

# Read files
df = pd.read_csv(edger_file)
...
plt.tight_layout()
plt.savefig(f"{OUT_DIR}/clean_volcano.png", dpi=300)
plt.savefig(f"{OUT_DIR}/clean_volcano.pdf")
